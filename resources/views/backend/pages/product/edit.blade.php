                    ...
                    <form action="{{ route('product.update', $products->slug) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label for="product-name" class="form-label">Select product</label>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="product_price" min="0"
                                    class="form-control @error('product_price') is-invalid @enderror" id="product_price" value="{{ $products->product_price }}">
                                @error('product_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" name="product_code"
                                    ...
                                    placeholder="enter a unique product code" value="{{ $products->product_code }}">
                                @error('product_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="product_stock" min="1"
                                    class="form-control @error('product_stock') is-invalid @enderror" id="product_stock" value="{{ $products->product_stock }}">
                                @error('product_stock')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="alert_quantity" min="1"
                                    class="form-control @error('alert_quantity') is-invalid @enderror" id="alert_quantity" value="{{ $products->alert_quantity }}">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror"
                                    id="short_description" id="" cols="30" rows="5">{{ $products->short_description }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="long_description" class="form-control @error('long_description') is-invalid @enderror"
                                    id="long_description" id="" cols="30" rows="5">{{ $products->long_description }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="additional_info" class="form-control @error('additional_info') is-invalid @enderror"
                                    id="additional_info" id="" cols="30" rows="5">{{ $products->additional_info }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="file" class="form-control dropify" name="product_image" id="" data-default-file="{{ asset("uploads/products/$products->product_image") }}">
                                @error('product_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-6 mb-3 form-check form-switch">
                                <input class="form-check-input" name="is_active" type="checkbox" role="switch"
                                    id="activeStatus" @if ($products->is_active) checked @endif>
